            ...
            <div class="row">
                ...
                <div class="col-xs-10 text-right menu-1">
                    <ul style="font-family: 'Source Code Pro' !important;">
                        <li style="margin: -10px" class="<?php $r = ($uri == "/index.php") ? 'active' : ''; echo $r ?>" style="margin: -10px !important;"><a href="../index.php">Start</a></li>
                        <li style="margin: -10px" class="<?php $r = ($uri == "/vorteile.php") ? 'active' : ''; echo $r ?>"><a href="../vorteile.php">Vorteile</a></li>
                        <li style="margin: -10px" class="has-dropdown <?php $r = ($uri == "/hardware.php" ) ? 'active' : ''; echo $r ?>">
                        ...
                        <li style="margin: -10px !important;" class="has-dropdown <?php $r = ($uri == "/software.php" || $uri == "teqly_config.php" || $uri == "microsoft_config.php") ? 'active' : ''; echo $r ?>">
                        ...
                        <li style="margin: -10px !important;" class="has-dropdown <?php $r = ($uri == "/swissmade.php") ? 'active' : ''; echo $r ?>">
                        ...
                        <li style="margin: -10px !important;" class="<?php $r = ($uri == "/contact.php") ? 'active' : ''; echo $r ?>"><a href="../kontakt.php">Kontakt</a></li>
