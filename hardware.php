...
<head>
    ...
    <title>TEQLY | Rental - Hardware</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description"
          content="Wir setzen auf Top Hardware von Schweizer Herstellern, erfahren Sie hier mehr über die verfügbaren Konfigurationen."/>
    <meta name="keywords"
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="fh5co-portfolio animate-box">
                        <a href="html/config/desktop_config.php">
                ...
                <div class="col-md-4">
                    <div class="fh5co-portfolio animate-box">
                        <a href="html/config/laptop_config.php">
                            <div class="portfolio-entry"
                ...
                <div class="col-md-4">
                    <div class="fh5co-portfolio animate-box">
                        <a href="html/config/server_config.php">
                            <div class="portfolio-entry"
                            ...
                            <div class="portfolio-text">
                                ...
                                <p style="color: #0b0b0b">Zuverlässigkeit, Leistungsstärke und ruhiger Betrieb, das sind
                                    nur einige der Eigenschaften, die unsere Server auszeichnen.</p>
                            </div>
                        </a>
                    </div>
                </div>
