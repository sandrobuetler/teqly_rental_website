                ...
                <div class="col-md-8 col-md-offset-2 text-center">
                    <div class="display-t js-fullheight">
                        <div class="display-tc js-fullheight animate-box" data-animate-effect="fadeIn">
                            ...
                            <img src="images/error/teqly_503.gif" style="padding-bottom: 20px">
                            <h2>Wir arbeiten mit hochdruck an Verbesserungen und neuen Features für dieses Fleckchen Internet. Wir sind gleich wieder für Sie da!</h2>
                        </div>
                    </div>
                </div>
            </div>
