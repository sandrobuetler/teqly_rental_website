...
<div id="page" style="background: white !important">
    ...
    <main>
        ...
        <div class="order">
            <div class="container">
                <h1 style="text-align: center">TEQLY | Rental - Kostenrechner</h1>
                            ...
                            <div id="teqlyGroup" class="row option-box">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <label class="cbx" for="tcs">
                                        ...
                                        <span id="tcsTitle">TEQLY | Cloud <strong>"Standard"</strong> | 500.-</span>
                                    </label>
                                </div>
                                <div class="col-md-6 col-sm-6">
                                    <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <label class="cbx" for="tcp">
                                        ...
                                        <span id="tcpTitle">TEQLY | Cloud <strong>"Premium"</strong> | 800.-</span>
                                    </label>
                                </div>
                                <div class="col-md-6 col-sm-6">
                                    <div class="row">
                            ...
                            <div id="microsoftGroup" class="row option-box">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <label class="cbx" for="mbs">
                                        ...
                                        <span id="mbsTitle">MS365 <strong>"Business Standard"</strong>  | 150.-</span>
                                    </label>
                                </div>
                                <div class="col-md-6 col-sm-6">
                                    <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <label class="cbx" for="mbp">
                                        ...
                                        <span id="mbpTitle">MS365 <strong>"Business Premium"</strong>  | 240.-</span>
                                    </label>
                                </div>
                                <div class="col-md-6 col-sm-6">
                                    <div class="row">
