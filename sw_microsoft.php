        ...
        <div class="container">
            ...
            <div class="row row-bottom-padded-md">
                <div class="col-md-12 text-center animate-box">
                    <p><img src="images/products/software/microsoft/teqly_microsoft_uebersicht.png"
                ...
                <div class="col-md-6 col-md-push-1 animate-box">
                    <aside id="fh5co-hero">
                        <div class="flexslider">
                            <ul class="slides">
                                <li style="background-image: url(images/products/software/microsoft/teqly_microsoft_teams.png);">
                                ...
                                <li style="background-image: url(images/products/software/microsoft/teqly_microsoft_onedrive.png);">
                                    <div class="overlay-gradient"></div>
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-md-12 col-md-offset-0 col-md-pull-10 slider-text slider-text-bg">
                                ...
                                <li style="background-image: url(images/products/software/microsoft/teqly_microsoft_suite.png);">
                                    <div class="overlay-gradient"></div>
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-md-12 col-md-offset-0 col-md-pull-10 slider-text slider-text-bg">
