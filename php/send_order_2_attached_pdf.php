...
if (!$errors) {
    ...
    if (isset($selected_mba)) {
        $order->addItem($selected_mba_title, '', $mba_qty, "7.7%", $selected_mba_price, false);
    }
    if (isset($selected_mbs)) {
        $order->addItem($selected_mbs_title, '', $mbs_qty, "7.7%", $selected_mbs_price, false);
    }
    if (isset($selected_mbp)) {
        $order->addItem($selected_mbp_title, '', $mbp_qty, "7.7%", $selected_mbp_price, false);
    }
